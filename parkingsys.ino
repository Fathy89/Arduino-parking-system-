...
if (analogRead(A0)<=300){   //  modifiy it on the maket 
  // turn on the led 
  digitalWrite(3,HIGH); 
...
// //============================================================
 digitalWrite(A5,0); 
    delay(1000);  //  just for indicaton the compiler position
 //===========================================================
...
open_servomotor(); 
 ...
 while(1){
    ...
    break;
      ...
      digitalWrite(A5,1); //  just for indicaton the compiler position
       delay(1000); 
